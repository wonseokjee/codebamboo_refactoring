...
const DynamicDraggable = dynamic(() => import('react-draggable'));
  ...
  return (
    ...
    >
      <div
        ...
        } bgImg-bamboo items-start w-full h-full min-h-[40rem] border-none z-40
      md:w-4/5 md:h-4/5
    `}
      >
        <div
          className='modal-inner-wrapper bg-neutral-50/95 h-full w-full min-w-[25rem] relative md:rounded-xl
      '
        >
          <header
        ...
        '
          ...
          '
            >
              <a
                href={OAUTH_NAVER}
                onClick={() => localStorage.setItem('prevPath', router.asPath)}
              >
