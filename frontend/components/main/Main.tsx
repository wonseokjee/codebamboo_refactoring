...
export default function Main() {
  ...
  return (
    <div className="relative w-full top-[700vh] h-[100vh] overflow-y-scroll z-30 scrollbar-hide">
      ...
      {isClient && isMobile && <div className="w-full h-10"></div>}
      <div
        className="m-5 mb-0 pl-5 pb-1 border-b-gray-600 border-b-2
                  text-2xl
                  md:mx-20 md:mt-7 md:text-3xl"
      >
        Popular
      </div>
